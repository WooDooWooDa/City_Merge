...
public static class SIPrefix
{
    ...
    private static void LoadSIPrefix()
    {
        _SIPrefixInfoList.AddRange(new SIPrefixInfo[]{
            ...
            new SIPrefixInfo() {Symbol = "", Prefix = "", Example = 100M, ZeroLength = 2, ShortScaleName = "Hundred", LongScaleName = "Hundred"},
            new SIPrefixInfo() {Symbol = "", Prefix = "", Example = 10M, ZeroLength = 1, ShortScaleName = "Ten", LongScaleName = "Ten"},
    ...
    {
        if (amount < 1000) return new SIPrefixInfo { AmountWithPrefix = amount.ToString("0.00") };
